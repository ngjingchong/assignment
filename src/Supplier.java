...
public class Supplier extends Personal_info{
    ...
    public Supplier(int id, String fName, String lName, int age, char gender, String phNum, String email, String joinDate, String street, String city, String state, int posCode, String country) {
    ...
    public void totalSales(int id){
    	...
    	if(id == 0){
    		for(int i=0; i<p.length; i++){
    			subtotal += (p[i].getTotalQtyPurchased()*p[i].getPrice());
    			count = i;
    		}
